...
//            super.onCallForwardingIndicatorChanged(changed);
            String message = getString(R.string.phone_status);
            message = message + getString(R.string.call_forwaded);
            Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
            Log.i(TAG, message);
        }
        // try if the service state shall work
//        @Override
...
//                    message = message + getString(R.string.emergency);
//                    Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
//                    Log.i(TAG, message);
//                    break;
//                case ServiceState.STATE_IN_SERVICE:
//                    message = message + getString(R.string.in_service);
//                    Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
//                    Log.i(TAG, message);
//                    break;
//                case ServiceState.STATE_OUT_OF_SERVICE:
//                    message = message + getString(R.string.out_service);
//                    Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
//                    Log.i(TAG, message);
//                    break;
//                case ServiceState.STATE_POWER_OFF:
//                    message = message + getString(R.string.power_off);
//                    Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
//                    Log.i(TAG, message);
//                    break;
//                default:
